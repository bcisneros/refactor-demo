...
**Key idea:** _No green tests → No refactor._
...
1. **Price and Quantity Validation**
   ...
   - If the base price is **less than or equal to zero**, the process stops and an error is raised: _"Invalid base price"_.
...
3. **Quantity-Based Discounts**
   ...
   - Orders of **more than 100 units** are **not allowed** and trigger an error: _"Too many products!"_.
...
- **Name by intent, not by mechanics**  
  Use descriptive names that explain _why_ something exists, not just _what_ it does.
...
- Feathers, M. C. (2004). _Working Effectively with Legacy Code_. Prentice Hall.
